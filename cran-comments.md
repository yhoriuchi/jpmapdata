...
GeoPackage files used by the jpmap package. Keeping these data separate lets
jpmap update its functionality without repeatedly redistributing the same
boundary files on CRAN mirrors.
